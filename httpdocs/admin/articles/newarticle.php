	...
	<main id="main-cont" class="row panel sidebar-on-right" role="main">
		...
		<div id="content" class="columns small-9 large-11">
			...
			<section id="article-info">
				...
				<div class="row">
					<div class="columns">
				  		<input type="text" name="article_img_credits_url-s" id="article_img_credits_url-s" placeholder="Enter image credits URL"  value="<?php if(isset($_POST['article_img_credits_url-s'])) echo $_POST['article_img_credits_url-s']; ?>" <?php if(isset($updateStatus) && isset($updateStatus['field']) && $updateStatus['field'] == 'article_img_credits_url') echo 'autofocus'; ?> />
					</div>
				</div>
