<div class="main-content-modal small-12 columns">
 ...
 <div class="column small-12 welcome-modal-footer">
    ...
    <div class="small-6 columns pagination-centered">
    	<ul role="pagination" class="small-12 columns pagination" >
	      ...
	      <li class="next"><i class="fa fa-circle" aria-hidden="true"></i></li>
	      <li class=""><a href="#" data-reveal-id="third" ><i class="fa fa-circle" aria-hidden="true"></i></a></li>
	      <li class=""><i class="fa fa-circle" aria-hidden="true"></i></li>
    	</ul>
    </div>
