<?php
	...
	if( $featuredArticle && $featuredArticle['article_status'] == 1){
		...
		$featuredArticleTitle = $featuredArticle['article_title'];
				...
				<div class="row imageContainer" id="<?php echo 'article-'.$articleIndex; ?>">
					<div class="small-12 columns imageCenterer">
						<a  class="" href="<?php echo $linkToArticle; ?>" >
							<img src="<?php echo $linkToImage; ?>" alt="<?php echo $featuredArticleTitle; ?>" />
						</a>
					</div>
				</div>				
				<div class="small-12 columns second-popular-article-title">
					<h2 class="left small-12 padding-top">
						<a href="<?php echo $linkToArticle; ?>" ><?php echo $featuredArticleTitle; ?></a>
					</h2>
				</div>
		...
		<div class="columns mobile-12 small-12 medium-12 large-12 xlarge-12 no-padding" id="article-featured-1">
			...
			<div class="mobile-12 small-12 medium-12 large-12 xlarge-12 mobile-vertical-center padding-top">
				<p class="left uppercase" ><span class="span-date"><?php echo $date; ?></span></p>
				...
				<a class="left clear-left" href="<?php echo $linkToArticle; ?>"><h1 class="h1-large-article"><?php echo $featuredArticleTitle; ?></h1></a>
			</div>
		</div>
