<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $config['this_url']; ?>assets/css/app_test.css" />
	...
	<script src="<?php echo $config['this_url']; ?>assets/js/modernizr.js"></script>
	<script src="<?php echo $config['this_url']; ?>assets/js/jquery.min.js"></script>
