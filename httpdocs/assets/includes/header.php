 ...
 <!-- <header id="top-banner" class="hide-for-print show-for-large-up">
  ...
  <?php }else{?>
   <div id="nav-bar" class="contain-to-grid hide-for-print column half-padding">
  <?php }?>
      ...
      <ul class="title-area">
        <li class="name" style="<?php if( $has_sponsored && $isHomepage ) echo 'margin-left: 10px;' ?>">
          <a href="<?php echo $config['this_url']; ?>">
            ...
            <?php }else{?>
                <img src="http://cdn.puckermob.com/articlesites/logos/Puckermob_logo.jpg" alt="PuckerMob Logo"> 
            <?php }?>
          </a>
        </li>
