<?php
 ...
 if(!$detect->isMobile()){ // Below IS NOT mobile ********************************************************************************************
...
<div id="nav_bar" style="z-index:1000000000 !important;"> 
      ...
      <div id="header-social" class="small-12 columns no-padding">
        ...
        <?php }else {?>
          <ul style="">
            ...
            <?php } // end  if( $warnings && $warnings[0] ... ?>
            <li><a  class="my-account-header-link" href="<?php echo $config['this_admin_url']; ?>/logout/">LOG OUT </a></li>
  ...
  <?php } // end  if(!$detect->isMobile()) Above IS NOT mobile ********************************************************************************************
   ?>
   

  <?php if($detect->isMobile()){ //Below IS mobile ******************************************************************************************************** ?>
    ...
    <nav id="top-bar-header-cont" class="top-bar" data-topbar="" data-options="scrolltop: false;"  style="<?php if($has_sponsored && $isHomepage) echo 'max-width: 56rem !important; '?>">
      ...
      <section class="top-bar-section category-colors" style="background-color:white;">
        ...
        <?php } //end if
         ...
         $nav_style = ( $has_sponsored && $isHomepage ) 'padding: 0 0 0 1.2rem !important; ' : '';
         ...
         ?>
          ...
          <li style="<?php echo $nav_style; ?>"><a href="<?php echo $config['this_url']; ?>most-recent"  class="entertainment" ></i>RECENT</a></li>
          <li style="<?php echo $nav_style; ?>"><a href="<?php echo $config['this_url']; ?>trending"  class="money" ></i>TRENDING</a></li>
          <li style="<?php echo $nav_style; ?>"><a href="<?php echo $config['this_url']; ?>most-popular"  class="wellness" >POPULAR</a></li>
          <li style="<?php echo $nav_style; ?>"><a href="<?php echo $config['this_url']; ?>contributors"  class="fun" >CONTRIBUTORS</a></li>
          <?php if(!$detect->isMobile()){?>
          <li style="<?php echo $nav_style; ?>"><a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><i class="fa fa-info-circle fa-lg info"></i></a></li>
          <li style="<?php echo $nav_style; ?>"><a>|</a></li>
             


          <?php }?>
          <li style="<?php echo $nav_style; ?>"><a href="<?php echo $config['this_url']; ?>moblog"  class="relationships" >THE MOB</a></li>
            <?php if($detect->isMobile()){?>
          <li style="<?php echo $nav_style; ?>"><a href="http://www.sequelmediainternational.com"  target="_blank" class="relationships" >Info & About Us</a></li>
          <li style="<?php echo $nav_style; ?>"><a href="http://www.puckermob.com/privacy/"  target="_blank" class="" >Privacy Policy</a></li>
          <li style="<?php echo $nav_style; ?>"><a href="http://www.puckermob.com/admin/login"  target="_blank" class="relationships" >WRITE FOR US</a></li>

           <li style="<?php echo $nav_style; ?>"><a href="http://www.puckermob.com/admin/login"  target="_blank" class="relationships" >LOGIN</a></li>
            <li style="<?php echo $nav_style; ?>"><a href="http://www.puckermob.com/admin/register"  target="_blank" class="relationships" >REGISTER</a></li>
            <?php } ?>
        </ul>
      </section>
    </nav>
