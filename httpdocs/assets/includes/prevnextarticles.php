...
if(isset($articleInfoObj) && $articleInfoObj){
	...
	<div id="prev-next-articles" class="row  hide-for-print clear <?php echo $borderClassContainer; ?>">
		...
		if( isset($prevArticle) && $prevArticle){
			...
			?>
			<!-- PREV ARTICLE -->
			<div id="prev-article" class="columns mobile-12 small-12 medium-6 <?php echo $borderClass.' '.$rightBorder; ?>">
				<div class="columns small-5 half-padding">
				...
				<div class="columns small-7 half-padding">
			...
			if( isset($nextArticle) && $nextArticle){
				...
				?>
				<!-- NEXT ARTICLE -->
				<div id="next-article" class="columns mobile-12 small-12 medium-6 <?php echo $borderClass; ?>">
