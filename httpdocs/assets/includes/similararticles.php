...
<hr class="show-for-xxlarge-only hr-hidden">
	...
	<div class="row half-padding-left half-padding-right">
		<?php
			...
			<a href="<?php echo 'http://www.puckermob.com/'.$category['cat_dir_name'].'/'.$article['article_seo_title']; ?>"><img src="<?php echo $config['image_url'].'articlesites/'.$mpArticle->data['article_page_assets_directory'].'/large/'.$article['article_id'].'_tall.jpg'; ?>" alt="<?php echo $article['article_title']; ?>" /></a>
