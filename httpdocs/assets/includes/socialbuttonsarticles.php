<div class="row social-media-container social-cont-1" style="margin-bottom: 0rem; display:block !important;">
	...
	<a id="google-plus-button" class="sm_googleplus social_button show-on-large-up" data-url="<?php echo $mpHelpers->curPageURL();?>" data-api-url="https://plusone.google.com/_/+1/fastbutton?url={url}">
	...
	<div id="shares_count" class="at4-jumboshare">
		<div class="at4-count" style="color: rgb(119, 119, 119);">
			<span id="shares_counter" class="shares_counter">0</span>
		</div>
