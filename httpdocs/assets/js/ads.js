...
if($('body').hasClass('mobile')) {
	...
	if( !smarties ){
		...
		if( adPage === 'article' ){
			...
			if(article_id == 7483){
				inBodyAd.loadInArticleAd( 'article-content', 1, 0, '<script type="text/javascript">kmn_iframe = true;kmn_placement = "7538b6e9386a88109f9b7f7363f3096e";<\/script><script type="text/javascript" src="//cdn.komoona.com/scripts/kmn_sa.js"><\/script>', tag);	
			...
			//1st GOOGLE
			if(article_id == 5049){
				inBodyAd.loadInArticleAd( 'article-content', first_p, 0, '<div id="kmni_7538b6e9386a88109f9b7f7363f3096e"><\/div><script>$.getScript("//cdn.komoona.com/scripts/kmn_sa.js").done(function( script, textStatus ) {kmn_sa.tag("7538b6e9386a88109f9b7f7363f3096e");});<\/script>', tag);
			}else{
