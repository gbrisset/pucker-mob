...
$(document).ready(function() {
	...
	var ad = {
		home: {
			header_970: '<script type="text/javascript">var ACE_AR = {site: \'907934\', size: \'970066\', async_fif: \'true\', async_fif_url: \'http://www.simpledish.com/aceFIF.HTML\', async_fif_timeout: \'200\'};</script><script type="text/javascript" SRC="http://uac.advertising.com/wrapper/aceUAC.js"></script>',
	...
	Foundation.utils.image_loaded(Foundation.utils.S('#aside img'), function(){
		...
		main.css("min-height", (asideHeight.atf + asideHeight.popular + asideHeight.connect + asideHeight.btf1 + asideHeight.trending + asideHeight.btf2 + (asideHeight.margin * 5) - 8));
	});
