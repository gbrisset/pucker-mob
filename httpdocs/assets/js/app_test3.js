...
$(document).ready(function() {
	...
	var base_url = 'http://www.simpledish.com';
	var URL = $(location).attr('href');
	var page = document.body.id;
	if(page != 'recipe' && page != 'home' && page != 'category') {var adPage = 'category';} else {var adPage = page;}
	...
	var trendy = Foundation.utils.S("#aside > #trending-now");
	var poparticles = Foundation.utils.S("#aside > #popular-articles");
	var ad = {
		home: {
			header_970: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/home;sect=home;sz=728x90,970x90;dc_ref='+encodeURIComponent(location.href)+';dcopt=ist;type=pop;type=int;ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			header_728: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/home;sect=home;sz=728x90;dc_ref='+encodeURIComponent(location.href)+';dcopt=ist;type=pop;type=int;ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			atf: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/home;sect=home;sz=300x250,300x600,300x1050;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			atf1050: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/home;sect=home;sz=300x1050;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			btf1: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/home_btf1;sect=home_btf1;sz=300x250;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			btf2: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/home_btf2;sect=home_btf2;sz=300x250;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			footer: '<script type="text/javascript" src=http://ad.doubleclick.net/N4403/adj/simpledish.com/home_btf;sect=home_btf;sz=728x90;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>'
		},
		category: {
			header_970: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/category_pages;sect=category_pages;sz=728x90,970x90;dc_ref='+encodeURIComponent(location.href)+';dcopt=ist;type=pop;type=int;ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			header_728: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/category_pages;sect=category_pages;sz=728x90;dc_ref='+encodeURIComponent(location.href)+';dcopt=ist;type=pop;type=int;ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			atf: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/category_pages;sect=category_pages;sz=300x250,300x600,300x1050;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			btf1: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/category_pages_btf1;sect=category_pages_btf1;sz=300x250;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			btf2: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/category_pages_btf2;sect=category_pages_btf2;sz=300x250;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			footer: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/category_pages_btf;sect=category_pages_btf;sz=728x90;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>'
		},
		recipe: {
			header_970: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/recipe_article_pages;sect=recipe_article_pages;sz=728x90,970x90;dc_ref='+encodeURIComponent(location.href)+';dcopt=ist;type=pop;type=int;ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			header_728: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/recipe_article_pages;sect=recipe_article_pages;sz=728x90;dc_ref='+encodeURIComponent(location.href)+';dcopt=ist;type=pop;type=int;ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			atf: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/recipe_article_pages;sect=recipe_article_pages;sz=300x250,300x600,300x1050;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			btf1: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/recipe_article_pages_btf1;sect=recipe_article_pages_btf1;sz=300x250;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			btf2: '<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/recipe_article_pages_btf2;sect=recipe_article_pages_btf2;sz=300x250;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>',
			footer:	'<script type="text/javascript" src="http://ad.doubleclick.net/N4403/adj/simpledish.com/recipe_article_pages_btf;sect=recipe_article_pages_btf;sz=728x90;dc_ref='+encodeURIComponent(location.href)+';ord=' + (window.ord || Math.floor(Math.random() * 1e16)) + '?"><\/script>'
		},
		lift: {
	...
	var select = {
		ad: {
			...
			atf1050: document.getElementById("atf1050-ad"),
	...
	var asideHeight = {
		...
		connect: Foundation.utils.S("#aside > #connect-with-us").height(),
		btf1: 0,
		trending: trendy.height(),
		btf2: 0,
		margin: parseInt(main.css("padding-bottom"))
	};
	Foundation.utils.image_loaded(Foundation.utils.S('#aside img'), function(){
		asideHeight.trending = trendy.height();
		asideHeight.popular = poparticles.height();
		main.css("min-height", (asideHeight.video + asideHeight.atf + asideHeight.popular + asideHeight.connect + asideHeight.btf1 + asideHeight.trending + asideHeight.btf2 + (asideHeight.margin * 6) - 8));
	});
	function resizeMainOnResize() {
		main.css("min-height", (asideHeight.video + asideHeight.atf + asideHeight.popular + asideHeight.connect + asideHeight.btf1 + asideHeight.trending + asideHeight.btf2 + (asideHeight.margin * 6) - 8));
	}
	function resizeMainOnAdLoad() {
		console.log(JSON.stringify(asideHeight));
		main.css("min-height", (asideHeight.video + asideHeight.atf + asideHeight.popular + asideHeight.connect + asideHeight.btf1 + asideHeight.trending + asideHeight.btf2 + (asideHeight.margin * 6) - 8));
	}
	...
	} else if(browser_width < 980) {
		loadAd(select.ad.header, ad[adPage].header_728);
		loadAd(select.ad.footer, ad[adPage].footer);
	} else {
		loadAd(select.ad.header, ad[adPage].header_970);
		loadAd(select.ad.footer, ad[adPage].footer);
		if(adPage === 'category') {
	...
	if(page === 'home') {
		loadAd(select.ad.atf1050, ad[adPage].atf1050);
	}
	...
	iFrameResize({
			...
			resizedCallback: function(messageData){
				...
				if(label === 'atf1050' && messageData.height > 100) {classToAdd += ' ad300 ad1050'; asideHeight[label]}
				if(label === 'atf' && messageData.height > 500) {
					if(label === 'atf' && messageData.height < 700) {
						classToAdd += ' ad300 ad600'; asideHeight[label] = 600 + asideHeight.margin; asideHeight.trending = trendy.height(); resizeMainOnAdLoad();
					}
					else {classToAdd += ' ad300 ad1050'; asideHeight[label] = 1050 + asideHeight.margin; asideHeight.trending = trendy.height(); resizeMainOnAdLoad();}
				}
				else if(label === 'atf' || label === 'btf1' || label === 'btf2') {classToAdd += ' ad300 ad250'; asideHeight[label] = 251 + asideHeight.margin; asideHeight.trending = trendy.height(); resizeMainOnAdLoad();}
				else if(label === 'header' || label === 'footer') {
					if(label === 'footer' || (label === 'header' && messageData.height < 110)) {classToAdd += ' ad90';}
