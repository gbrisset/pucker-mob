...
<?php if ($mpArticle->data['has_google_ad_sense']) { ?>
	...
	//	Start google adsense appending...
			document.getElementById('ad-300-atf').appendChild(document.getElementById('ad1_footer'));
			document.getElementById('ad1_footer').style.display = 'inline';

			document.getElementById('ad-300-btf1').appendChild(document.getElementById('ad2_footer'));
			document.getElementById('ad2_footer').style.display = 'inline';

			document.getElementById('ad-300-btf2').appendChild(document.getElementById('ad3_footer'));
...
<?php } ?>
	...
	$('.media-net-unit').children('iframe').css('display', 'inline !important');
});