...
/*END Slider Functions */
	...
	$('#featured-article-cont, #recipe-box-cont, #search-header-cont').appendAround();
...
/* HomePage Video Playlist & Player Settings */
	if($('#mp-video-player-cont').length){
		<?php if ($local){ ?>
					...
					logoImgLink: '',
					flashSwfUrl:"http://syndication.mypodstudios.com/assets/swf/MyPodHTML5Player.swf",
					adSwfUrl:"http://syndication.mypodstudios.com/assets/swf/MyPodAdPlayer.swf",
					playlist : 'http://syndication.playlists.mypodstudios.com/foodanddrink&id=<?php echo $mpArticle->data['player_setting_api_key']?>',
//					playlist : 'http://syndication.playlists.mypodstudios.com/testdefault&id=OWEwN2QxMzhkNWYxMDJmZmMzNDVmMTAzNmIzZmRlZmNkYWFjNTI4Zg==',
...
//					randomizePlaylist : <?php echo ($mpArticle->data['player_setting_randomize_playlist'] == 1) ? 'true' : 'false'; ?>,
					...
					flashSwfUrl:"http://syndication.mypodstudios.com/assets/swf/MyPodHTML5Player.swf",
					adSwfUrl:"http://syndication.mypodstudios.com/assets/swf/MyPodAdPlayer.swf",
					playlist : 'http://syndication.playlists.mypodstudios.com/<?php echo $mpArticle->data['player_setting_playlist_slug']; ?>&id=<?php echo $mpArticle->data['player_setting_api_key']; ?>',
					callbacks:{
						adBreakStarted : function(){$('#ad-300-atf-companion').show();},
		                adBreakEnded : function(){$('#ad-300-atf-companion').hide();},
						videoChange : function(){
...
/* Series Page Playlist & Player Settings */
	...
	if($('#mp-series-video-player-cont').length){
		...
		<?php if ($local){ ?>
					...
					flashSwfUrl:"http://syndication.mypodstudios.com/assets/swf/MyPodHTML5Player.swf",
					adSwfUrl:"http://syndication.mypodstudios.com/assets/swf/MyPodAdPlayer.swf",
					playlist : 'http://syndication.playlists.mypodstudios.com/'+serieInformation+'&id=ZjM2YTcwZDJjZTk1YjUzMWI0NjYwYjdjZTMxODIyZTExNDkyOTBkNQ==',
