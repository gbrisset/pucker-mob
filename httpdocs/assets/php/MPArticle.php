...
public  function get_filtered($limit = 10, $order = '', $articleStatus = '1, 2, 3', $userArticlesFilter, $offset, $articleType = 'all' ) {
	...
	$s = "SELECT a.article_id, a.article_title, a.article_seo_title, a.article_desc, a.article_body, a.article_status, a.creation_date,
	 a.article_agree_edits,  a.article_lock_status, nc.cat_id, nc.cat_dir_name, '0' as us_traffic, article_contributors.contributor_name, article_contributors.contributor_seo_name, users.user_email, users.user_type, users.user_id 
	FROM articles as a
