...
<head>
	...
	<body>
			<?php
				...
				$articles = $GoogleAnalyticsData->queryGoogleAnalyticsInformation($analytics, $startDate, $date, $params);
				$arrArticles = [];
				if($articles){
				...
				$GoogleAnalyticsData->removeGoogleAnalyticsMostViewArticlesAlways();
				$insert = $GoogleAnalyticsData->saveGoogleAnalyticsMostViewArticlesAlways($arrArticles);
