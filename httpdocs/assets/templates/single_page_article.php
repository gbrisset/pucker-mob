...
if (isset($articleInfoObj)) {
	...
	//$get_rating = $articleInfoObj['rating'];
	//$rating = $mpHelpers->roundToNearestHalf($get_rating);
	//$reviews = $articleInfoObj['reviews'];
...
<article id="" class="columns small-12 microsidebar-article">
